...
public class JSONObject {
	...
	public int getInt(String key) throws JSONException {
		Object o = get(key);
		return o instanceof Number ? ((Number) o).intValue() : Integer.valueOf((String)o).intValue();
	}
	...
	public String getStringDefEmpty(String key) throws JSONException {
	...
	public Object getByPath(List<String> paths) throws JSONException {
		JSONObject o = this;
		for (int i = 0; i < paths.size(); i++) {
			String jk = paths.get(i);
			if (i == paths.size() - 1) {
				return o.get(jk);
			} else {
				o = o.getJSONObject(jk);
			}
		}
		return null;
	}
